...
CONFIG VALUES YOU SHOULD CHANGE
	...
	1. ForcedSleep. If this is 0 (the default), SwResMon will eat a lot of CPU time. Changing it to ~0.1 is usually pretty good and uses <5% of CPU time.
...
Credits to Razer|Node for the slick icons, & Laurent for his awesome SFML2 library.
